# TOOL korp-kwic-vks.py: "Get Korp KWIC concordance from VKS corpus"
# (Queries korp.csc.fi for a KWIC concordance from VKS corpus. Input file contains CQP expressions separated by empty lines. They must all match. The last of them defines the final match. Output file is the concordance in the Korp JSON form.)
