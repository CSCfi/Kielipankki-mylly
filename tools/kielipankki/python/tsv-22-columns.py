# TOOL tsv-22-columns.py: "Contingency columns of two TSV combinations"
# (Contingency table of two combinations of TSV attributes as joint count cM12, other count cM1o, and column margins aka sums cMs2 and cMso. The component attribute names are suffixed with of1 and of2.)
