# TOOL tsv-22-corner.py: "Contingency tables as corners"
# (Make contingency tables for two combinations of relation attributes. Joint count is named cM12, other counts cM1o, cMo2, total sum cMss. The component attribute names are suffixed with of1 and of2.)
