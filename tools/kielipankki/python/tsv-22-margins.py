...
# (Contingency table of two combinations of TSV attributes represented as joint count cM12 and three sums aka marginal counts cM1s, cMs2, cMss. The component attribute names are suffixed with of1 and of2.)
