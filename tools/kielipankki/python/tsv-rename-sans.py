# TOOL tsv-rename-sans.py: "Rename attributes without using COLUMN_SEL"
# (Rename selected attributes. EMPTY is not a name.)
# INPUT old.tsv TYPE GENERIC
# OUTPUT new.tsv
# PARAMETER          old0: "old name" TYPE STRING
# PARAMETER          new0: "new name" TYPE STRING
# PARAMETER OPTIONAL old1: "old name" TYPE STRING
# PARAMETER OPTIONAL new1: "new name" TYPE STRING
# PARAMETER OPTIONAL old2: "old name" TYPE STRING
